...
```
╔══════════════════════════════════════════════════════════════╗
║   🐟  CULTER AGENT  ·  P₃ 鲌类专研  ·  v1.0.1                ║
║  ─────────────────────────────────────────────────────────  ║
║  鲌类基因组学 · 营养生态位 · 年龄生长 · 6 种鲌属                ║
║      翘嘴鲌 · Culter alburnus · von Bertalanffy               ║
╚══════════════════════════════════════════════════════════════╝
```
...
| 版本 | 日期 | 主题 |
|------|------|------|
| **v1.0.1** | 2026-06-18 | 六物种 + P₃ 整合 |
| **v1.0.0** | 2026-06-18 | 初始发布 · 鲌类基因组学 |
...
`鲌类` `基因组学` `营养生态位` `年龄生长` `von-Bertalanffy` `稳定同位素` `ReAct循环` `淡水鱼类` `Reasonix` `MCP`
